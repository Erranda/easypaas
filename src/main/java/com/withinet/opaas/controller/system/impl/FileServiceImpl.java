...
public class FileServiceImpl implements FileService {
	 ...
	 * 
	 * @see
	 * com.withinet.opaas.controller.system.FileService#createFile(java.lang
	 * .String)
	 */
	@Override
	public File createFile(String fileLocation) {
		...
		if (!forCreate.exists())
			if (forCreate.isFile() || forCreate.isDirectory()) {
				try {
	 ...
	 * 
	 * @see
	 * com.withinet.opaas.controller.system.FileService#deleteFile(java.lang
	 * .String)
	 */
	@Override
