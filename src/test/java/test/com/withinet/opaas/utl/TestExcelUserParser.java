...
public class TestExcelUserParser {
	...
	public void testParseName() throws UserParserException {
		assertTrue (ExcelUserParser.parse("src/test/resources/test.xls").get(0).getFullName().equals("Folarin"));
	}
	
	@Test
	public void testParseEmail() throws UserParserException {
		assertTrue (ExcelUserParser.parse("src/test/resources/test.xls").get(0).getEmail().equals("abc@xyz.com"));
	}
	
	@Test
	public void testParseQuota() throws UserParserException {
		assertTrue (ExcelUserParser.parse("src/test/resources/test.xls").get(0).getQuota().equals(2));
	}
